...
<section class="flex-box" id="topo">
            <div class="row ">
                <div class="col-lg-12">
                    <div class="col-md-2">
                        <a href="#">
                            <img class="img-responsive" src="public/images/brasao.svg" >
                        </a>
                    </div>
                    <div class="col-md-6" >
                        <h2>Coworking Chalé 10</h2>
                        <h4> Prefeitura Municipal de Rio Grande</h4>
                        <h4>Mercado Público Municipal de Rio Grande</h4>
                    </div>

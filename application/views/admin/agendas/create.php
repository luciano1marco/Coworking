            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <?php echo form_label('Data', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_input($dia); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo form_label('Horário', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_dropdown($hora); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo form_label('Espaço', 'nome', array('class' => 'col-sm-2 control-label')); ?>
                            <div class="col-sm-6">
                                <?php echo form_dropdown($mesa); ?>
                            </div>
                        </div>
